...
public class RejectCollateralRelease {
	...
	//	click on 3dot Icon
       ...
       Thread.sleep(2000);
       driver.findElement(By.xpath("//*[@id=\"body\"]/div[6]/div[1]/form/div[2]/select/option[4]")).click();
        
        driver.findElement(By.xpath("//*[@id=\"body\"]/div[6]/div[1]/form/div[3]/textarea")).sendKeys("All details are  not Ok");
        Thread.sleep(2000);
        //click on submit
