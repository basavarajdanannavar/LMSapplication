...
public class RejectChargeClosureByBM  {
	...
	@Test(priority=2)
	public void ChargeClosure(String collateral) throws InterruptedException {
		Thread.sleep(2000);
		...
		//click on the Search Icon 
				...
				driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div"));
				Thread.sleep(3000);
		//click on 3 dot Icon
	...
	//	Click on View
		...
		driver.findElement(By.xpath("/html/body/div[2]/div/div[3]/div/div[2]/div/div[1]/div/div[3]/img")).click();
		Thread.sleep(1000);
		//Click on Reject Charge Closure
		driver.findElement(By.xpath("//*[@id=\"body\"]/div[4]/div/ul/li[2]/div/strong")).click();
		Thread.sleep(2000);
		//Enter the reason
		driver.findElement(By.cssSelector("[ng-model='action.confirmReason.field.reason.value']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"body\"]/div[6]/div[1]/form/div[2]/select/option[2]")).click();
		
		driver.findElement(By.xpath("//*[@id=\"body\"]/div[6]/div[1]/form/div[3]/textarea")).sendKeys("All Details are OK");
		Thread.sleep(1000);
		//click on submit
