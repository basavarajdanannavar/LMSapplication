...
public class ReleaseMovementComplete  {
	...
	@Test(priority=3)
	public void TrackOngoingTrip() throws InterruptedException, AWTException {
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/div/div[3]/ul/li[5]/div/div/div/div/input")).sendKeys("150000");
