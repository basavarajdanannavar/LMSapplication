...
public class RequestChargeConfirmationByFO  {
...
//click on the Search Collateral Link
 ...
 Thread.sleep(5000);
	...
	WebElement confirm =driver.findElement(By.xpath("/html/body/div[4]/div/ul/li[1]/div/strong"));
	...
	//Enter Loan Number
  	...
  	Robot rb=new Robot();
   	...
   	rb.delay(2000);
   	  ...
   	  StringSelection check=  new StringSelection("C:\\Users\\Lenovo\\OneDrive\\Desktop\\Gold Loan Photos\\internal_appraisal_certificate_010126001974 (1).pdf");
