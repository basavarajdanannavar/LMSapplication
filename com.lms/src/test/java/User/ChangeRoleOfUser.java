...
public class ChangeRoleOfUser extends LoginwithValidCredential {
	...
	public void EditApplication() throws AWTException, InterruptedException {
		...
		//select the roles
		driver.findElement(By.xpath("//*[@id=\"mat-option-36\"]/mat-pseudo-checkbox")).click();
		Thread.sleep(1000);
		
	driver.findElement(By.id("mat-option-34")).click();
